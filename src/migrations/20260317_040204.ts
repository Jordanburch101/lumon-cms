...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_media_src_idx\` ON \`pages_blocks_hero\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_poster_src_idx\` ON \`pages_blocks_hero\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`heroCtrd_order_idx\` ON \`heroCtrd\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`heroCtrd_parent_id_idx\` ON \`heroCtrd\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`heroCtrd_path_idx\` ON \`heroCtrd\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`heroCtrd_media_src_idx\` ON \`heroCtrd\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`heroCtrd_poster_src_idx\` ON \`heroCtrd\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`heroStat_stats_order_idx\` ON \`heroStat_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`heroStat_stats_parent_id_idx\` ON \`heroStat_stats\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`heroStat_order_idx\` ON \`heroStat\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`heroStat_parent_id_idx\` ON \`heroStat\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`heroStat_path_idx\` ON \`heroStat\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`heroStat_media_src_idx\` ON \`heroStat\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`heroStat_poster_src_idx\` ON \`heroStat\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`heroMin_order_idx\` ON \`heroMin\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`heroMin_parent_id_idx\` ON \`heroMin\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`heroMin_path_idx\` ON \`heroMin\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_chart_data_order_idx\` ON \`pages_blocks_bento_chart_data\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_chart_data_parent_id_idx\` ON \`pages_blocks_bento_chart_data\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_order_idx\` ON \`pages_blocks_bento\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_parent_id_idx\` ON \`pages_blocks_bento\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_path_idx\` ON \`pages_blocks_bento\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_bento_image_image_src_idx\` ON \`pages_blocks_bento\` (\`image_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_split_media_rows_order_idx\` ON \`pages_blocks_split_media_rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_split_media_rows_parent_id_idx\` ON \`pages_blocks_split_media_rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_split_media_rows_media_src_idx\` ON \`pages_blocks_split_media_rows\` (\`media_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_gallery_items_order_idx\` ON \`pages_blocks_image_gallery_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_gallery_items_parent_id_idx\` ON \`pages_blocks_image_gallery_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_gallery_items_image_idx\` ON \`pages_blocks_image_gallery_items\` (\`image_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_latest_articles_order_idx\` ON \`pages_blocks_latest_articles\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_latest_articles_parent_id_idx\` ON \`pages_blocks_latest_articles\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_latest_articles_path_idx\` ON \`pages_blocks_latest_articles\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cinematic_cta_order_idx\` ON \`pages_blocks_cinematic_cta\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cinematic_cta_parent_id_idx\` ON \`pages_blocks_cinematic_cta\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cinematic_cta_path_idx\` ON \`pages_blocks_cinematic_cta\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cinematic_cta_video_src_idx\` ON \`pages_blocks_cinematic_cta\` (\`video_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_features_grid_items_order_idx\` ON \`pages_blocks_features_grid_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_features_grid_items_parent_id_idx\` ON \`pages_blocks_features_grid_items\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_features_grid_order_idx\` ON \`pages_blocks_features_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_features_grid_parent_id_idx\` ON \`pages_blocks_features_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_features_grid_path_idx\` ON \`pages_blocks_features_grid\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_members_links_order_idx\` ON \`pages_blocks_team_members_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_members_links_parent_id_idx\` ON \`pages_blocks_team_members_links\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_stats_order_idx\` ON \`pages_blocks_trust_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_stats_parent_id_idx\` ON \`pages_blocks_trust_stats\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_logos_order_idx\` ON \`pages_blocks_trust_logos\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_logos_parent_id_idx\` ON \`pages_blocks_trust_logos\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_logos_logo_idx\` ON \`pages_blocks_trust_logos\` (\`logo_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_order_idx\` ON \`pages_blocks_trust\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_parent_id_idx\` ON \`pages_blocks_trust\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_trust_path_idx\` ON \`pages_blocks_trust\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_rich_text_content_order_idx\` ON \`pages_blocks_rich_text_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rich_text_content_parent_id_idx\` ON \`pages_blocks_rich_text_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_rich_text_content_path_idx\` ON \`pages_blocks_rich_text_content\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_partners_order_idx\` ON \`pages_blocks_partner_grid_partners\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_partners_parent_id_idx\` ON \`pages_blocks_partner_grid_partners\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_partners_logo_idx\` ON \`pages_blocks_partner_grid_partners\` (\`logo_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_order_idx\` ON \`pages_blocks_partner_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_parent_id_idx\` ON \`pages_blocks_partner_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_partner_grid_path_idx\` ON \`pages_blocks_partner_grid\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_tabs_features_order_idx\` ON \`pages_blocks_tabbed_content_tabs_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_tabs_features_parent_id_idx\` ON \`pages_blocks_tabbed_content_tabs_features\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_tabs_order_idx\` ON \`pages_blocks_tabbed_content_tabs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_tabs_parent_id_idx\` ON \`pages_blocks_tabbed_content_tabs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_tabs_image_idx\` ON \`pages_blocks_tabbed_content_tabs\` (\`image_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_order_idx\` ON \`pages_blocks_tabbed_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_parent_id_idx\` ON \`pages_blocks_tabbed_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_tabbed_content_path_idx\` ON \`pages_blocks_tabbed_content\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_features_order_idx\` ON \`pages_blocks_comparison_table_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_features_parent_id_idx\` ON \`pages_blocks_comparison_table_features\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_plans_values_order_idx\` ON \`pages_blocks_comparison_table_plans_values\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_plans_values_parent_id_idx\` ON \`pages_blocks_comparison_table_plans_values\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_plans_order_idx\` ON \`pages_blocks_comparison_table_plans\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_comparison_table_plans_parent_id_idx\` ON \`pages_blocks_comparison_table_plans\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_job_listings_jobs_order_idx\` ON \`pages_blocks_job_listings_jobs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_job_listings_jobs_parent_id_idx\` ON \`pages_blocks_job_listings_jobs\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_job_listings_order_idx\` ON \`pages_blocks_job_listings\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_job_listings_parent_id_idx\` ON \`pages_blocks_job_listings\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_job_listings_path_idx\` ON \`pages_blocks_job_listings\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_media_src_idx\` ON \`_pages_v_blocks_hero\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_poster_src_idx\` ON \`_pages_v_blocks_hero\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_heroCtrd_v_order_idx\` ON \`_heroCtrd_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_heroCtrd_v_parent_id_idx\` ON \`_heroCtrd_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_heroCtrd_v_path_idx\` ON \`_heroCtrd_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_heroCtrd_v_media_src_idx\` ON \`_heroCtrd_v\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`_heroCtrd_v_poster_src_idx\` ON \`_heroCtrd_v\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_heroStat_v_stats_order_idx\` ON \`_heroStat_v_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_heroStat_v_stats_parent_id_idx\` ON \`_heroStat_v_stats\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_heroStat_v_order_idx\` ON \`_heroStat_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_heroStat_v_parent_id_idx\` ON \`_heroStat_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_heroStat_v_path_idx\` ON \`_heroStat_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_heroStat_v_media_src_idx\` ON \`_heroStat_v\` (\`media_src_id\`);`)
  await db.run(sql`CREATE INDEX \`_heroStat_v_poster_src_idx\` ON \`_heroStat_v\` (\`poster_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_heroMin_v_order_idx\` ON \`_heroMin_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_heroMin_v_parent_id_idx\` ON \`_heroMin_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_heroMin_v_path_idx\` ON \`_heroMin_v\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_chart_data_order_idx\` ON \`_pages_v_blocks_bento_chart_data\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_chart_data_parent_id_idx\` ON \`_pages_v_blocks_bento_chart_data\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_order_idx\` ON \`_pages_v_blocks_bento\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_parent_id_idx\` ON \`_pages_v_blocks_bento\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_path_idx\` ON \`_pages_v_blocks_bento\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_bento_image_image_src_idx\` ON \`_pages_v_blocks_bento\` (\`image_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_split_media_rows_order_idx\` ON \`_pages_v_blocks_split_media_rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_split_media_rows_parent_id_idx\` ON \`_pages_v_blocks_split_media_rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_split_media_rows_media_src_idx\` ON \`_pages_v_blocks_split_media_rows\` (\`media_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_gallery_items_order_idx\` ON \`_pages_v_blocks_image_gallery_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_gallery_items_parent_id_idx\` ON \`_pages_v_blocks_image_gallery_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_gallery_items_image_idx\` ON \`_pages_v_blocks_image_gallery_items\` (\`image_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_latest_articles_order_idx\` ON \`_pages_v_blocks_latest_articles\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_latest_articles_parent_id_idx\` ON \`_pages_v_blocks_latest_articles\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_latest_articles_path_idx\` ON \`_pages_v_blocks_latest_articles\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cinematic_cta_order_idx\` ON \`_pages_v_blocks_cinematic_cta\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cinematic_cta_parent_id_idx\` ON \`_pages_v_blocks_cinematic_cta\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cinematic_cta_path_idx\` ON \`_pages_v_blocks_cinematic_cta\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cinematic_cta_video_src_idx\` ON \`_pages_v_blocks_cinematic_cta\` (\`video_src_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_band_order_idx\` ON \`_pages_v_blocks_cta_band\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_band_parent_id_idx\` ON \`_pages_v_blocks_cta_band\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_band_path_idx\` ON \`_pages_v_blocks_cta_band\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_features_grid_items_order_idx\` ON \`_pages_v_blocks_features_grid_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_features_grid_items_parent_id_idx\` ON \`_pages_v_blocks_features_grid_items\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_features_grid_order_idx\` ON \`_pages_v_blocks_features_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_features_grid_parent_id_idx\` ON \`_pages_v_blocks_features_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_features_grid_path_idx\` ON \`_pages_v_blocks_features_grid\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_members_links_order_idx\` ON \`_pages_v_blocks_team_members_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_members_links_parent_id_idx\` ON \`_pages_v_blocks_team_members_links\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_stats_order_idx\` ON \`_pages_v_blocks_trust_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_stats_parent_id_idx\` ON \`_pages_v_blocks_trust_stats\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_logos_order_idx\` ON \`_pages_v_blocks_trust_logos\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_logos_parent_id_idx\` ON \`_pages_v_blocks_trust_logos\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_logos_logo_idx\` ON \`_pages_v_blocks_trust_logos\` (\`logo_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_order_idx\` ON \`_pages_v_blocks_trust\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_parent_id_idx\` ON \`_pages_v_blocks_trust\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_trust_path_idx\` ON \`_pages_v_blocks_trust\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rich_text_content_order_idx\` ON \`_pages_v_blocks_rich_text_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rich_text_content_parent_id_idx\` ON \`_pages_v_blocks_rich_text_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rich_text_content_path_idx\` ON \`_pages_v_blocks_rich_text_content\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_partners_order_idx\` ON \`_pages_v_blocks_partner_grid_partners\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_partners_parent_id_idx\` ON \`_pages_v_blocks_partner_grid_partners\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_partners_logo_idx\` ON \`_pages_v_blocks_partner_grid_partners\` (\`logo_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_order_idx\` ON \`_pages_v_blocks_partner_grid\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_parent_id_idx\` ON \`_pages_v_blocks_partner_grid\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_partner_grid_path_idx\` ON \`_pages_v_blocks_partner_grid\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_tabs_features_order_idx\` ON \`_pages_v_blocks_tabbed_content_tabs_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_tabs_features_parent_id_idx\` ON \`_pages_v_blocks_tabbed_content_tabs_features\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_tabs_order_idx\` ON \`_pages_v_blocks_tabbed_content_tabs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_tabs_parent_id_idx\` ON \`_pages_v_blocks_tabbed_content_tabs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_tabs_image_idx\` ON \`_pages_v_blocks_tabbed_content_tabs\` (\`image_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_order_idx\` ON \`_pages_v_blocks_tabbed_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_parent_id_idx\` ON \`_pages_v_blocks_tabbed_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_tabbed_content_path_idx\` ON \`_pages_v_blocks_tabbed_content\` (\`_path\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_features_order_idx\` ON \`_pages_v_blocks_comparison_table_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_features_parent_id_idx\` ON \`_pages_v_blocks_comparison_table_features\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_plans_values_order_idx\` ON \`_pages_v_blocks_comparison_table_plans_values\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_plans_values_parent_id_idx\` ON \`_pages_v_blocks_comparison_table_plans_values\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_plans_order_idx\` ON \`_pages_v_blocks_comparison_table_plans\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_comparison_table_plans_parent_id_idx\` ON \`_pages_v_blocks_comparison_table_plans\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_job_listings_jobs_order_idx\` ON \`_pages_v_blocks_job_listings_jobs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_job_listings_jobs_parent_id_idx\` ON \`_pages_v_blocks_job_listings_jobs\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_job_listings_order_idx\` ON \`_pages_v_blocks_job_listings\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_job_listings_parent_id_idx\` ON \`_pages_v_blocks_job_listings\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_job_listings_path_idx\` ON \`_pages_v_blocks_job_listings\` (\`_path\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_tabbed_content_tabs_features\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_comparison_table_plans_values\`;`)
